			...
			(commentL)=>(
				<section key={"marvelcanadacommentleft"+commentL.commentid} className="comment-single">
					<div className="comment-single-left">
						<img src={"static/img/users/profile/"+commentL.userid+".png"} />
						<div>
							<h4>{commentL.name}</h4>
					...
					<img alt={commentL.name+" in "+commentL.park} src={"static/img/park/"+commentL.parkid+"/"+commentL.pic+".jpg"} />
				</section>
		    )
		);
		let commentRight = this.props.data2.map(
			(commentR)=>(
				<section key={"marvelcanadacommentright"+commentR.commentid} className="comment-single">
					<div className="comment-single-left">
						<img src={"static/img/users/profile/"+commentR.userid+".png"} />
						<div>
							<h4>{commentR.name}</h4>
					...
					<img alt={commentR.name+" in "+commentR.park} src={"static/img/park/"+commentR.parkid+"/"+commentR.pic+".jpg"} />
				</section>
		    )
		);
		return (
...
ReactDOM.render(<Comment data1={data1} data2={data2} />, document.getElementById('comment'));
