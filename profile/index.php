                        ...
                        <div class="tab-content clearfix">
                            ...
                            <div id="wishlist" class="tab-pane fade">
                                ...
                                <div id="w1" class="display-group">
                                    <div class="row">
                                        <div class="col col-xs-4 col-lg-4 wishlist-group__thumbnail">
                                            <img src="../static/img/park/0/0.jpg" alt="Park picture" />
                                        </div>
                                        <div class="col col-xs-8 col-lg-8 wishlist-group__park-details">
                                            <div>
                                ...
                                <div id="w2" class="display-group">
                                    <div class="row">
                                        ...
                                        <div class="col col-xs-8 col-lg-8 wishlist-group__park-details">
                                            ...
                                            <div class="wishlist-group__park-address">[North Rustico, PE C0A, Canada]</div>
                                            <div class="wishlist-group__park-province">[Prince Edward Island]</div>
                                        </div>
                                    </div>
                                    <div class="row wishlist-group__footer">
                                        <div class="col col-xs-12 col-lg-12">
                                            <span>Added on [Jan 29, 2017]</span>
                                            &nbsp;|&nbsp;
                                            <span><a href="" alt="Link to remove park from wishlist">Remove</a></span>
                                        </div>
                                    </div>
